...
class HotelManagementSystem:
    def __init__(self, root):  # calls constractor
        ...
        # ********1st image *********
        img1 = Image.open(
            r"C:\Users\HP\Desktop\Hotel_management\hotelhero.png")
        img1 = img1.resize((1550, 140), Image.ANTIALIAS)
        self.photoimg1 = ImageTk.PhotoImage(img1)
        lblimg = Label(self.root, image=self.photoimg1, bd=4, relief=RIDGE)
        lblimg.place(x=0, y=0, width=1550, height=140)
        #postion of start x and y axis
        # LOGO
        ...
        lbl_title = Label(self.root, text="HOTEL MANAGEMENT SYSTEM", font=(
            "times new roman", 40, "bold"), bg="purple", fg="Yellow", bd=4, relief=RIDGE)
        ...
        policy_btn = Button(btn_frame, text="DETAILS", width=22, font=(
            "times new roman", 14, "bold"), bg="black", fg="gold", bd=0, cursor="hand1")
        policy_btn.grid(row=2, column=0, pady=1)
        ...
        img3 = Image.open(r"C:\Users\HP\Desktop\Hotel_management\ppp.jpeg")
 ...
 ######################Down_side
        ...
        img4 = Image.open(r"C:\Users\HP\Desktop\Hotel_management\u.jpeg")
        img4 = img4.resize((230, 210), Image.ANTIALIAS)
        self.photoimg4 = ImageTk.PhotoImage(img4)
        lblimg1 = Label(main_frame, image=self.photoimg4, bd=4, relief=RIDGE)
        lblimg1.place(x=0, y=225, width=230, height=210)

        img5 = Image.open(r"C:\Users\HP\Desktop\Hotel_management\pic1.jpg")
        img5 = img5.resize((230, 190), Image.ANTIALIAS)
        self.photoimg5 = ImageTk.PhotoImage(img5)
        lblimg1 = Label(main_frame, image=self.photoimg5, bd=4, relief=RIDGE)
        lblimg1.place(x=0, y=420, width=230, height=190)

#create variable new_window
